 ...
 */
public class PaintingRender extends Render<PaintingBase>
{
    private final ResourceLocation paintingTexture;

    protected PaintingRender(RenderManager renderManager, String location)
    {
        super(renderManager);
        paintingTexture = new ResourceLocation(ACPainting.MOD_ID, "textures/painting/" + location + ".png");
    }
